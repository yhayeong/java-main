...
public class Ex11_2_3_4 {
	public static void main(String[] args) {
		...
		list.add(2);
		list.add(7);
		HashSet set = new HashSet(list); // 2637(중복x 순서x)
		TreeSet tset = new TreeSet(set); // 2367(정렬)
...
//		}
		 ...
		 * Ex11_3
		 * 
		 * ArrayList는 검색에 유리. 저장과 삭제할때 불리(이유:하나씩 밀거나 땡겨야함)
		 * 
		 ...
		 * 
		 * 정답은 중간요소: 6(5인덱스) 
		 * 이중 원형 연결리스트에서는 마지막 요소에 접 하기 위해서는 첫 번째 요소에서 한 번만 이동하면 된다.
		 * 마지막 요소에서 첫 번째 요소에 접근하기 위해서도 역시 한 번만 이동하면 된다.
