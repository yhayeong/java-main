...
/* 문제: 
Studenttt클래스의 기본정렬을 이름(name)이 아닌 총점 
...
public class Ex11_8 {
	...
	public static void calculateSchoolRank(List list) {
		 ...
		 * 1. 반복문을 이용해서 list에 저장된 Studenttt객체를 하나씩 읽는다. 
	...
	public static void main(String[] args) {
		...
		list.add(new Studenttt("이자바", 2, 1, 70, 90, 70));
		list.add(new Studenttt("안자바", 2, 2, 60, 100, 80));
		list.add(new Studenttt("홍길동", 1, 3, 100, 100, 100));
		list.add(new Studenttt("남궁성", 1, 1, 90, 70, 80));
		list.add(new Studenttt("김자바", 1, 2, 80, 80, 90));
